...
const onCardReceived = async (requestString) => {
    ...
    const isSyncRequest = requestString.startsWith('REQ:SYNC_PING') || requestString.startsWith('REQ:CHALLENGE') || requestString.startsWith('REQ:DELTA') || requestString.startsWith('ACK:SYNC_LEDGER');
